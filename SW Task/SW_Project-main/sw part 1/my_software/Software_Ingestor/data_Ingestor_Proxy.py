...
"""
import time
from my_software.Software_Ingestor.data_Ingestor import Ingestor
from my_software.Software_Processing_Engine.processing_engine import ProcessingEngine
from my_software.Software_Ingestor.error import IngestorError,ProcessingEngineError

class Ingestor_Proxy:
    """
    Ingestor_Proxy class that send msg every 5s 
    """
